...
return'¤⁞ اصدار سورس ايجل : *v'..version..'* '
end
...
sendMsg(arg.chat_id_,arg.id_,'✲ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ايجل يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ عذرا هذا الحساب محظور من سيرفرات حماية ايجل ") end
