...
return sendMsg(arg.ChatID,arg.MsgID,"💠⁞ لا يمكنك تقييد *مطورين الالماسـه* ؛") 
...
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقييد *مطورين الالماسـه* ؛") 
...
if not msg.SudoBase then return " ⌯⁞  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://github.com/AL-Ma-Sa/MaSa/raw/main/v.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'💠 عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الالماسـه يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل *مطورين الالماسـه* ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"💠⁞ عذرا هذا الحساب محظور من سيرفرات حماية الالماسـه ") end
