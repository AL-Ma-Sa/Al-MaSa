...
return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ لا يمكنك تقييد *مطورين الماسه* ؛") 
...
elseif UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then 
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقييد *مطورين الماسه* ؛") 
...
elseif UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then 
return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ لا يمكنك طرد *مطورين الماسه*؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then 
return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ لا يمكنك حظر *مطورين الماسه* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then 
return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ لا يمكنك كتم *مطورين الماسه* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
if UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين الماسه* \n") end
...
msg = arg.msg
if UserID == 1714422669 or UserID == 1755055191 or UserID == 932948575 or UserID == 127952353 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *مطورين الماسه* ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoBase then return " ♨⁞  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/AL-Ma-Sa/MaSa/main/v.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'✲ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الماسـه يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : نيـزك ",url="t.me/diamondsabot"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: نيـزك](t.me/diamondsabot)',nil,inline,msg.id_)
return false
end
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل *مطورين الماسه* ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
return sendMsg(ChatID,MsgID,"¤⁞ لا يمكنك حظر *مطورين الماسه* ؛") 
end
if redis:sismember(js..'bannedpv',UserID) then 
...
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر *مطورين الماسه* ؛") 
end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"¤⁞ عذرا هذا الحساب محظور من سيرفرات حماية الماسـه ") end
...
dofile("./MaSa/Run.lua")
print("Update Source And Reload ~ ./MaSa/Run.lua And change username sudo")
